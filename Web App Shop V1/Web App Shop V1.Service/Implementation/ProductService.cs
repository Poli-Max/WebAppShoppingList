...
namespace Web_App_Shop_V1.Service.Implementation;
...
public class ProductService : IProductService
{
    ...
    public async Task<IBaseResponse<Product>> GetProductOne(int id)
    {
    ...
    public async Task<IBaseResponse<IEnumerable<Product>>> GetProductsAll()
    {
    ...
    public async Task<IBaseResponse<ProductViewModels>> CreateProduct(ProductViewModels model)
    {
    ...
    public async Task<IBaseResponse<Product>> EditProduct(int id, ProductViewModels model)
    {
        var baseResponce = new BaseResponse<Product>();
        try
        {
    ...
    public async Task<IBaseResponse<List<Product>>> GetProductsByFilters(string productName, decimal? minPrice, decimal? maxPrice)
    {
        ...
        try
        {
            ...
            {
                productsQuery = productsQuery.Where(x => x.name.Contains(productName));
            }
